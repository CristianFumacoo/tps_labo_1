...
int controller_addEmployee(LinkedList* pArrayListEmployee)
{
    ...
    if(pArrayListEmployee != NULL)
    {
        ...
        aux_getCadena(&auxNombre,51,"Ingrese Nombre: ","Error.Ingrese Nombre: ",5);
        aux_getNumeroInt(&auxSueldo,"Ingrese Sueldo: ","Error.Ingrese Sueldo: ",0,9999999,5);
        aux_getNumeroInt(&auxHoras,"Ingrese Horas de Trabajo: ","Error.Ingrese Horas de Trabajo: ",0,9999999,5);


        if(employee_setId(empleado,buscarId(pArrayListEmployee)+1),
...
int buscarId(LinkedList* pArrayListEmployee)
{
    int retorno = -1;
    int i;
    int flag = 0;
