...
int main()
{
    ...
    do
    {
        ...
        {
            case 1:
                aux_getNumeroFlotante(&numUno,"Ingrese el primer numero: ","Ingreso mal el numero. Ingrese numero: ",-1000,1000,3);
                flagNumUno = 1;
            break;

            case 2:
                aux_getNumeroFlotante(&numDos,"Ingrese el primer numero: ","Ingreso mal el numero. Ingrese numero: ",-1000,1000,3);
                flagNumDos = 1;
            break;
